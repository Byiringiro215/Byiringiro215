...
<p align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&duration=3000&pause=1000&center=true&vCenter=true&width=500&lines=Building+end-to-end+digital+solutions;Frontend+%7C+Backend+%7C+Mobile+%7C+AI;From+beautiful+UIs+to+powerful+systems;React+%2F+Node.js+%2F+Next.js+%2F+MongoDB" alt="Typing SVG" />
</p>
...
💻 I design and build **complete digital products** — from intuitive user interfaces to scalable backend systems.

🚀 Currently engineering **AI-powered platforms**, where intelligent systems meet seamless user experiences.

🎨 Strong in frontend craftsmanship, while equally focused on **performance, architecture, and backend logic**.

⚙️ Passionate about creating **efficient APIs, databases, and system flows** that power real-world applications.

🧩 A proud student of Rwanda Coding Academy, sharpening my skills to graduate as a **fullstack innovator by 2027**.

🌍 Building not just apps, but **impactful, scalable solutions** — one commit at a time.
